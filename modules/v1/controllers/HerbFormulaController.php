...
class HerbFormulaController extends BaseController
{
    ...
    /**
     * Create new herb formula
     *
     * @param null|integer $id Herb ID
     *
        ...
        if(is_array($request)) {
            ...
            if(isset($request[0])) {
                ...
                if(sizeof($excluded) > 0) {
                    ...
                    return $this->sendResponse('Existing formulas has been removed');
                }
            }
        }
    ...
    public function actionUpdate($id)
    {
        ...
        $formulaHerb->load(\Yii::$app->request->post(), '');
