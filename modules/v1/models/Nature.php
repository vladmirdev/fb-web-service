 ...
 */
class Nature extends ActiveRecord
{
    const ITEM_TYPE = 'nature';

	public $herb_nature_id;
    ...
    public function fields()
    {
        ...
        if($action == 'v1/herb/natures')
            return ['id','name','is_deleted','created_by','created_time','modified_by','modified_time','herb_nature_id'];
        else
