...
/**
 * This is the model class for table "herb_category".
 *
 * @property integer $id
 ...
 */
class HerbCategory extends ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['herb_id', 'category_id'], 'required'],
            [['herb_id', 'category_id', 'is_deleted', 'created_by', 'modified_by'], 'integer'],
            ...
            [['category_id'], function ($attribute, $params) {
                ...
                if($model->type !== Herb::ITEM_TYPE)
                    $this->addError($attribute, sprintf('Cannot assign category with type "%s" to herb', $model->type));
    ...
    {
        return ['id', 'herb_id', 'category_id', 'is_deleted'];
    }
