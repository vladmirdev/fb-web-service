...
/**
 * This is the model class for table "preparation_category".
 *
 * @property integer $id
 ...
 */
class PreparationCategory extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['prep_id', 'category_id'], 'required'],
            [['prep_id', 'category_id', 'is_deleted', 'created_by', 'modified_by'], 'integer'],
            ...
            [['category_id'], function ($attribute, $params) {
                ...
                if($model->type !== Preparation::ITEM_TYPE)
                    $this->addError($attribute, sprintf('Cannot assign category with type "%s" to preparation method', $model->type));
