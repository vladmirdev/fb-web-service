...
{
    const ITEM_TYPE = 'specie';

	public $herb_species_id;
    ...
    public function fields()
    {
        ...
        if($action == 'v1/herb/species')
            return ['id','name','is_deleted','created_by','created_time','modified_by','modified_time','herb_species_id'];
        else
