...
/**
 * This is the model class for table "formula_category".
 *
 * @property integer $id
 ...
 */
class FormulaCategory extends ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['formula_id', 'category_id'], 'required'],
            [['formula_id', 'category_id', 'is_deleted', 'created_by', 'modified_by'], 'integer'],
            ...
            [['category_id'], function ($attribute, $params) {
                ...
                if($model->type !== Formula::ITEM_TYPE)
                    $this->addError($attribute, sprintf('Cannot assign category with type "%s" to formula', $model->type));
    ...
    {
        return ['id', 'formula_id', 'category_id', 'is_deleted'];
    }
