...
class m171012_075729_languages_references extends Migration
{
    public function up()
    {
        $sql = <<<SQL
...
CHANGE `id` `id` int(10) unsigned NOT NULL COMMENT 'ID' AUTO_INCREMENT FIRST,
CHANGE `iso` `code` char(2) COLLATE 'utf8_general_ci' NULL COMMENT 'ISO Code' AFTER `id`,
CHANGE `name` `name` varchar(255) COLLATE 'utf8_general_ci' NULL COMMENT 'Language' AFTER `code`,
...
ADD `created_time` timestamp NULL COMMENT 'Created time' AFTER `created_by`,
ADD `modified_by` int(11) NULL COMMENT 'Modified by' AFTER `created_time`,
ADD `modified_time` timestamp NULL COMMENT 'Modified time' AFTER `modified_by`,
...
SQL;
    ...
    {
        echo "m171012_075729_languages_references cannot be reverted.\n";
